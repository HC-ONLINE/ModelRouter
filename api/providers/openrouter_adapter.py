...
class OpenRouterAdapter(ProviderAdapter):
    ...
    def _get_headers(self) -> dict[str, str]:
        ...
        headers.update({
            "HTTP-Referer": "https://github.com/modelrouter",  # Requerido por OpenRouter
            "X-Title": "ModelRouter"  # Opcional pero recomendado
        })
        return headers
                ...
                for line in chunk_text.split('\n'):
                    ...
                    if line.startswith('data: '):
                        ...
                        try:
                            ...
                            logger.warning(f"[OpenRouter] No se pudo parsear chunk: {data_str}")
                            continue
