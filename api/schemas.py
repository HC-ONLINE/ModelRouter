...
class ChatRequest(BaseModel):
    ...
    max_tokens: int = Field(default=512, ge=1, le=4096, description="Máximo de tokens a generar")
    temperature: float = Field(default=0.0, ge=0.0, le=2.0, description="Temperatura para generación")
    ...
    model: Optional[str] = Field(default=None, description="Modelo específico a usar (opcional)")
...
class ErrorResponse(BaseModel):
    ...
    request_id: Optional[str] = Field(default=None, description="ID de la request para trazabilidad")
