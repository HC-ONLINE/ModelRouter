...
async def lifespan(app: FastAPI):
    ...
    if settings.openrouter_api_key:
        ...
        logger.warning("OPENROUTER_API_KEY no configurada, OpenRouter no estará disponible")
    
    if not providers:
        logger.error("No hay proveedores configurados. La aplicación no funcionará correctamente.")
    ...
    orchestrator = Orchestrator(
        ...
        max_operation_timeout=settings.max_operation_timeout
    )
